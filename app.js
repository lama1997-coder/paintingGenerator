...
function setupEventListeners() {
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            // }
            if (!globalReferenceToggle.checked && currentTitle.references) {
                const newRefs = currentTitle.references.filter(ref => !ref.id);

                console.log(`Uploading ${newRefs.length} new references in parallel`);
            ...
            //    await generateServerThumbnails(currentTitle, 'references', quantity, false);
